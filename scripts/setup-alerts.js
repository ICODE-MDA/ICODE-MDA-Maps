...
<<<<<<< HEAD
   ...
   $.getScript('http://localhost:8080/owf/js-min/owf-widget-min.js', function()
   {
      ...
      function initPublisher() {
          ...
          this.widgetEventingController.publish("setupAlert", "true");   
       }
      ...
      function initListener() {
          this.widgetEventingController = Ozone.eventing.Widget.getInstance();
          this.widgetEventingController.subscribe('updatePolygonField', polygonListener);
      }

      function polygonListener(sender,msg)
      {
         updatePolygonField(msg);
      }

      function handleStateEvent(sender, msg) {
         this.widgetEventingController = Ozone.eventing.Widget.getInstance();
         this.widgetEventingController.publish("setupAlert", "false"); 
      }

      // OWF Event monitoring
      var eventMonitor = {};
      ...
      eventMonitor.widgetState = Ozone.state.WidgetState.getInstance({
         ...
         autoInit: true,
         //widgetGuid: 'e5494c07-9e2d-0603-e7c0-b8f1fd7b1618',
