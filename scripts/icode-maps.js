...
function MIDtoCountry(mmsi) {
   ...
   switch (parseInt(mmsi.toString().substr(0,3))) {
      ...
      case 619: countryName = "C𴥠d'Ivoire (Republic of)"; break;
      ...
      case 660: countryName = "R궮ion (French Department of)"; break;
      ...
      case 668: countryName = "S䯠Tom顡nd Pripe (Democratic Republic of)"; break;
