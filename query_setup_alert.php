...
$query = "INSERT INTO $alert_database.alert_properties (user_id, alert_interval, polygon, entering, exiting) VALUES ('$userid', $interval, $polygon, $entering, $exiting)";


exit($polygon . ' ' . $email . ' ' . $entering . ' ' . $exiting . '<br>' . $query);
//========================================END=============================
